...
const Contactus = () => {
  ...
  return (
    <div className='flex items-center justify-between px-4 md:px-24 py-14 bg-morebisque rounded-2xl mt-20'>
      ...
      <img  className='hidden md:block w-1/3' src='/images/operator.png' alt='operator.png' />
    </div>
  )
}
